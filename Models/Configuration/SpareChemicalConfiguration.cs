...
{
    public class SpareChemicalConfiguration : IEntityTypeConfiguration<SpareChemical>
    {
        public void Configure(EntityTypeBuilder<SpareChemical> builder)
        {
            builder.ToTable("SPARE_QUIMICOS_RC");
